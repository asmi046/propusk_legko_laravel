    ...
    <div class="__container">
        ...
        <div class="rules-block d_flex jc_sb">
            <div class="rules-block__list d_flex f_col border_block">
                ...
                <p>Транспорт категории В с грузоподъемностью свыше 1 тонны не может заезжать в зону ТТК и СК с 7:00 до 23:00 ежедневно, необходим пропуск в эти зоны действия. При этом экологический класс машины должен соответствовать Евро 2 и выше.</p>
            </div>

            <div class="rules-block__list d_flex f_col border_block">
                <img src="/img/3,5t-car.svg" alt="Грузовая машина свыше 1 тонны">
                <p>Если масса грузового автомобиля выше 3,5 тонн, ему запрещается въезжать на МКАД незавиимо от времени суток.</p>
            </div>
